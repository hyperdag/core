/**
 * @file version.h
 * @brief Version information for Meta-Graph library
 *
...
#define METAGRAPH_API_VERSION_STRING "0.1.0-alpha"
...
#define METAGRAPH_BUILD_TIMESTAMP "@BUILD_TIMESTAMP@"
#endif

#ifndef METAGRAPH_BUILD_COMMIT_HASH
#define METAGRAPH_BUILD_COMMIT_HASH "@GIT_COMMIT_HASH@"
#endif

#ifndef METAGRAPH_BUILD_BRANCH
#define METAGRAPH_BUILD_BRANCH "@GIT_BRANCH@"
#endif
 ...
 */
void mg_build_details(const char **timestamp, const char **commit_hash,
                            const char **branch);
 ...
 */
int mg_feature_available(const char *feature_name);
 ...
 */
int mg_api_compatible(int required_major, int required_minor,
                            int required_patch);
 ...
 */
int mg_bundle_compatible(int bundle_version);
