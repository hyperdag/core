...
typedef enum {
    ...
    HYPERDAG_ERROR_INVALID_ALIGNMENT_VALUE =
    ...
    HYPERDAG_ERROR_USER_DEFINED_START =
 ...
 */
hyperdag_result_t
hyperdag_set_error_context(hyperdag_result_t code, const char *file, int line,
...
#define HYP_ERR_CODE(code)                                                     \
    hyperdag_set_error_context((code), __FILE__, __LINE__, __func__, "%s",     \
                               hyperdag_result_to_string(code))
