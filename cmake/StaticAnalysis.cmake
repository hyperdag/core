...
option(HYPERDAG_COVERAGE "Enable code coverage" OFF)
if(HYPERDAG_COVERAGE)
...
option(HYPERDAG_PGO "Enable Profile-Guided Optimization" OFF)
if(HYPERDAG_PGO AND CMAKE_BUILD_TYPE STREQUAL "Release")
    if(CMAKE_C_COMPILER_ID STREQUAL "GNU" OR CMAKE_C_COMPILER_ID STREQUAL "Clang")
        add_compile_options(-fprofile-generate)
        add_link_options(-fprofile-generate)
        message(STATUS "Profile-Guided Optimization (generate phase) enabled")
        message(STATUS "Run your benchmarks, then reconfigure with -DHYPERDAG_PGO_USE=ON")
    endif()
endif()

option(HYPERDAG_PGO_USE "Use Profile-Guided Optimization data" OFF)
if(HYPERDAG_PGO_USE AND CMAKE_BUILD_TYPE STREQUAL "Release")
    if(CMAKE_C_COMPILER_ID STREQUAL "GNU" OR CMAKE_C_COMPILER_ID STREQUAL "Clang")
